...
namespace BDSA2017.Lecture10.App.Models
{
    ...
    {
        private readonly Uri _baseAddress = new Uri("http://localhost:51874/");

        private readonly HttpClient _client;

        public RestCharacterRepository(HttpClient client)
        {
        ...
        public async Task<CharacterDetailsDTO> FindAsync(int characterId)
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                character.Image = new Uri(_baseAddress, $"api/characters/{characterId}/image").ToString();
